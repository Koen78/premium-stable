...
import eu.premium.stable.config.audit.AuditEventConverter;
import eu.premium.stable.domain.PersistentAuditEvent;
...
import static eu.premium.stable.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
